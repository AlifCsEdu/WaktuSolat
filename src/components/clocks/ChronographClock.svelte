<script lang="ts">
  ...
  let hours24 = $derived(time.getHours() + minutes / 60);
</script>
...
<div class={cn(
  ...
  <div class={cn(
    ...
    <svg class="absolute inset-0 w-full h-full -rotate-90">
      <circle cx="50%" cy="50%" r="43%" fill="none" stroke="currentColor" class="text-[var(--md-sys-color-outline-variant)]/20" stroke-width="1.5" />
      <circle cx="50%" cy="50%" r="43%" fill="none" stroke="currentColor" class="text-[var(--md-sys-color-primary)]" stroke-width="2" stroke-dasharray="{(prayerProgress / 100) * 270} 270" stroke-linecap="round" />
    </svg>
    <span class={cn(
  ...
  <div class={cn(
    ...
    <span class="absolute top-0.5 text-[8px] sm:text-[9px] font-black text-[var(--md-sys-color-on-surface-variant)]/70 select-none">24</span>
    <span class="absolute bottom-0.5 text-[8px] sm:text-[9px] font-black text-[var(--md-sys-color-on-surface-variant)]/70 select-none">12</span>
  ...
  <div class={cn(
    ...
    <span class="font-sans font-black text-[9px] sm:text-[10px] select-none tabular-nums">{format(time, "dd")}</span>
  </div>
  ...
  <div class="absolute top-1/2 left-1/2 w-2.5 h-2.5 -ml-1.25 -mt-1.25 bg-white rounded-full z-30 pointer-events-none"></div>
