...
<div class={cn(
  ...
  {#if visualStyle !== 'glass'}
    <div class="absolute inset-0 rounded-full shadow-[inset_0_0_20px_var(--md-sys-color-primary)] opacity-10 pointer-events-none"></div>
  {/if}
  ...
  <div class="absolute top-1/2 left-1/2 w-2.5 h-2.5 -ml-1.25 -mt-1.25 bg-[var(--md-sys-color-error)] rounded-full z-30 pointer-events-none shadow-[0_0_8px_var(--md-sys-color-error)]"></div>
