...
export function SettingsModal({
  ...
  const handleResetToDefaults = () => {
    // 1. Reset general settings in AppContext
    updateSettings(DEFAULT_GENERAL_SETTINGS);
    
    // 2. Reset prayer-specific alert configurations
    onResetPreferences();
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
              ...
              {/* Left Sidebar Drawer (Desktop Only) */}
              <div className="hidden md:flex flex-col w-64 border-r border-[var(--md-sys-color-outline)]/10 bg-[var(--md-sys-color-surface-container-low)] p-4 space-y-2 shrink-0 overflow-y-auto no-scrollbar">
                {[
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "relative overflow-hidden w-full flex items-center gap-3 px-4 py-3 rounded-2xl transition-all text-left font-bold text-sm select-none",
                        isActive
                    ...
                    >
                      {/* @ts-ignore */}
                      <md-ripple></md-ripple>
                      <Icon className={cn("w-5 h-5 transition-colors", isActive ? "text-[var(--md-sys-color-primary)]" : "text-[var(--md-sys-color-on-surface-variant)]/70")} size={18} />
                      <span>{tab.label}</span>
                    </button>
                  );
                })}
              ...
              <div className="md:hidden w-full overflow-x-auto no-scrollbar border-b border-[var(--md-sys-color-outline)]/10 shrink-0">
                {/* @ts-ignore */}
              ...
              <div className="flex-1 overflow-y-auto px-4 sm:px-8 pb-8 pt-6 space-y-6 custom-scrollbar bg-[var(--md-sys-color-surface-container-lowest)]">
                ...
                {activeTab === "general" && (
                  <div className="space-y-6 max-w-2xl mx-auto">
                    ...
                    <div className={cn("rounded-[32px] p-6 space-y-6", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container)] border border-[var(--md-sys-color-outline)]/5 shadow-sm"))}>
                    ...
                    <div className={cn("rounded-[32px] overflow-hidden flex flex-col", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container)] border border-[var(--md-sys-color-outline)]/5 shadow-sm"))}>
                    ...
                    {/* Collapsible Advanced & Offline Options */}
                    <div className={cn(
                      "rounded-[32px] overflow-hidden transition-all duration-300 mt-4",
                      showAdvancedGeneral
                ...
                {activeTab === "notifications" && (
                  <div className="space-y-6 max-w-2xl mx-auto">
                    ...
                    {/* QoL Action Toggles */}
                    <div className={cn("p-4 rounded-[2rem] border border-[var(--md-sys-color-outline)]/10 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[var(--md-sys-color-surface-container-high)]", getStyleClasses(visualStyle))}>
                      <div>
                    ...
                    {/* Visual Alerts Style Settings Card */}
                    <div className={cn("p-6 sm:p-8 rounded-[var(--md-sys-shape-corner-extra-large)] space-y-6", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container-high)] ring-1 ring-[var(--md-sys-color-outline)]/10 shadow-sm"))}>
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-on-primary-container)] flex items-center justify-center">
                                ...
                                {SOUND_OPTIONS.map((opt) => (
                                  ...
                                  <md-filter-chip
                                    ...
                                    onClick={() => {
                                      ...
                                      // Auto-play audition preview instantly
                                      onTestSound(
                                        opt.value,
                                        `${t("testSoundBody" as any)} ${t(key as any)}`
                                      );
                      ...
                      <div className="space-y-4 mt-4">
                        {PRAYER_KEYS.map((key) => {
                          ...
                          return (
                            <div
                              key={key}
                              className={cn("flex items-center justify-between p-4 sm:p-5 rounded-[2rem] transition-shadow", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface)] shadow-sm ring-1 ring-[var(--md-sys-color-outline)]/5 hover:shadow-md"))}
                            >
                ...
                {activeTab === "advanced" && (
                  <div className="space-y-6 max-w-2xl mx-auto pb-4">
                    {/* Sunnah Settings */}
                    <div className={cn("rounded-[32px] p-6 sm:p-8 border border-[var(--md-sys-color-outline)]/5 shadow-sm space-y-6", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container)]"))}>
                    ...
                    <div className={cn(
                      "rounded-[32px] overflow-hidden transition-all duration-300 shadow-sm",
                    ...
                    <div className={cn(
                      "rounded-[32px] overflow-hidden transition-all duration-300 shadow-sm mt-4",
                      showHijriEngine
                        ? getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container)] p-6 space-y-6 border border-[var(--md-sys-color-outline)]/10")
                        : getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container-low)] hover:bg-[var(--md-sys-color-surface-container)] p-4 sm:p-5 border border-transparent")
                    )}>
                    ...
                    <div className={cn("rounded-[32px] p-6 sm:p-8 border border-[var(--md-sys-color-outline)]/5 shadow-sm space-y-4 mt-6", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container)]"))}>
                      <div className="flex items-center gap-3">
                      ...
                      <div className="pt-2 border-t border-[var(--md-sys-color-outline)]/10 flex flex-wrap items-center gap-4 justify-between">
                      ...
                      {showResetToast && (
                        <motion.div
                          ...
                          exit={{ opacity: 0, y: 10 }}
                          className="p-3 bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-on-primary-container)] text-xs font-bold rounded-2xl flex items-center gap-2 shadow-sm"
                        >
                          <Check size={16} className="stroke-[3]" />
                ...
                {activeTab === "mosque" && (
                  <div className="space-y-8 max-w-xl mx-auto pb-6">
                    ...
                    {/* BACKGROUND UTILITY */}
                    <div className={cn("p-6 sm:p-8 rounded-[var(--md-sys-shape-corner-extra-large)] space-y-4", getStyleClasses(visualStyle, "bg-[var(--md-sys-color-surface-container-high)] ring-1 ring-[var(--md-sys-color-outline)]/10 shadow-sm"))}>
