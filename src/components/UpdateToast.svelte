...
>
  <div class="bg-[var(--md-sys-color-surface-container-highest)]/85 border border-[var(--md-sys-color-outline)]/20 shadow-2xl rounded-[28px] p-5 flex flex-col gap-4 backdrop-blur-xl transition-all duration-300">
